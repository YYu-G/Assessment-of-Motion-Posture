...
if __name__ == '__main__':
    yogaPoseDetect(pose_mode='modelFile/yolov8n.pt',  #关键点检测模型
                   detect_model='modelFile/yoga-model.h5',  #训练好的瑜伽评估模型
                   video_path='temp/1725980959.3687475_test_video.mp4',  #需要检测的视频文件路径，若为0，则打开摄像头
                   video_save_dir='reportFile/results'  #保存结果视频路径
                   )
